document.addEventListener("DOMContentLoaded", function() {
    ...
    webinar.addEventListener("submit", function(event) {
        ...
        name.innerText = name.innerText.toUpperCase();
    });

    function validateForm() {
        
        if (nameError.innerText || timeError.innerText || event_dateError.innerText || locationError.innerText || deadlineError.innerText || organizer_nameError.innerText || phone_numberError.innerText || feeError.innerText || urlError.innerText || speakerError.innerText ) {
